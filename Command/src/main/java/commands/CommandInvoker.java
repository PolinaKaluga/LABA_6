...
public class CommandInvoker {
    ...
    public CommandInvoker(UserIO userIO) { //для клиента
        ...
        this.userIO = userIO;
        this.ticketFieldsReader = new TicketFieldsReader(userIO);
    ...
    public CommandInvoker(UserIO userIO, TicketFieldsReader ticketFieldsReader, ExecuteScriptCommand.Script script) {
        this.clientCommands = new HashMap<>();
